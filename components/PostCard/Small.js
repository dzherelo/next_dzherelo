            ...
            <a href={slug} className="group">
                <div className="relative">
                    <img 
                        ...
                        src={ imgUrl }
                    />
                    {featured === true ? <div className="absolute top-4 right-2 px-4 py-1 bg-brand-green rounded rotate-6 group-hover:rotate-2 transform-gpu ease-out transition duration-150"> <p className="text-lg text-brand-background">{t.featured}</p></div> : ""}
